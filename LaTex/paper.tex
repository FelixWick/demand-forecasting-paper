...
\caption{\label{fig:cdf_demand} \textcolor{red}{CDF histogram}}
\end{center}
\end{figure}
...
\caption{\label{fig:invquant_mean} \textcolor{red}{invquant profile for mean predictions of all product-location-day combinations on x-axis}}
\end{center}
\end{figure}
...
\caption{\label{fig:invquant_dayofweek} \textcolor{red}{invquant profile for day of week of one product over all locations and days on x-axis}}
\end{center}
\end{figure}
