...
The 1st Wasserstein distance, also known as earth mover'۪s distance (EMD), represents a distance function defined between two probability distributions on a given metric space, and for our purposes here can defined by
